        ...
        <div className="grid gap-3 md:grid-cols-3">
          <div className="rounded-lg bg-white p-4 border border-[#dce4f3]">
            ...
            <ul className="space-y-1.5 text-sm text-[#4a5568]">
              <li className="flex items-start gap-2"><span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-[#f55d78]" />식품기사 자격증 준비 필요</li>
              <li className="flex items-start gap-2"><span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-[#f55d78]" />품질·위생 실습 경험의 직무형 정리 부족</li>
              <li className="flex items-start gap-2"><span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-[#f0b03f]" />캡스톤디자인·HACCP 경험 증빙 보완 필요</li>
            </ul>
          </div>
          <div className="rounded-lg bg-white p-4 border border-[#dce4f3]">
            ...
            <ol className="space-y-1.5 text-sm text-[#4a5568]">
              ...
              <li className="flex items-center gap-2"><span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#6b8ef5] text-[10px] font-bold text-white">2</span>위생사 (위생·안전 직무 연계)</li>
              <li className="flex items-center gap-2"><span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#a0b4f5] text-[10px] font-bold text-white">3</span>수산제조기사 (가공 직무 확장)</li>
            </ol>
          </div>
          <div className="rounded-lg bg-white p-4 border border-[#dce4f3]">
            ...
            <p className="text-sm text-[#64748b] leading-6">목표 기업(희창유업·코카콜라) 지원 기준으로 자소서와 포트폴리오는 <span className="font-semibold text-[#3a5fd9]">2026년 2월</span>까지 상시 지원 가능 상태로 준비하는 것이 적절합니다.</p>
          </div>
        </div>
      </div>
