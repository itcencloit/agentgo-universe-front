          ...
          <div className="flex-1">
            ...
            <div className="mt-3 grid gap-3 md:grid-cols-2">
              <div className="rounded-lg border border-[#dce4f3] bg-white p-4">
                <div className="mb-2 text-xs font-semibold text-[#3a5fd9]">AI 추천 상담 유형</div>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={item.type} className="flex items-start gap-2 rounded border border-[#e8eef6] bg-[#f8fafd] px-3 py-2">
              ...
              <div className="rounded-lg border border-[#dce4f3] bg-white p-4">
                <div className="mb-2 text-xs font-semibold text-[#3a5fd9]">AI 생성 상담 의제</div>
                <div className="space-y-1.5">
                  {[
                    ...
                    <div key={agenda} className="flex items-start gap-2 text-xs text-[#364457]">
            ...
            <div className="mt-3 rounded-lg border border-[#d6e0f4] bg-[#eef2fb] px-4 py-2.5">
              <div className="mb-1 text-xs font-semibold text-[#3a5fd9]">AI 상담 준비 체크리스트</div>
              <div className="grid gap-1 text-xs text-[#4a5d8a] md:grid-cols-2">
      ...
      {tab === 'guide' && (
        <>
          <div className="rounded-xl border border-[#dce4f3] bg-[#f8fbff] px-5 py-4">
            <div className="mb-1 text-sm font-bold text-[#364457]">진로취업 개인상담이란?</div>
            <p className="text-sm leading-6 text-[#5d6b7e]">
              학생들의 진로설계 및 취업준비를 도와주는 1:1 상담 프로그램입니다. 국가자격증을 보유한 상담 선생님과 함께 적합한 진로를 설계하고 효과적인 취업준비를 할 수 있습니다.
          ...
          <SectionCard eyebrow="상담 구조" title="구조화된 상담 5단계">
            ...
            <p className="mt-3 text-xs text-[#8a9ab5]">* 학생의 개별 상태에 따라 시작 단계가 달라질 수 있습니다.</p>
          </SectionCard>
