...
export const SectionCard: React.FC<SectionCardProps> = ({ children, eyebrow, headerRight, subtitle, title }) => {
  return (
    <section className="rounded-md border border-[#d6def0] bg-white shadow-sm">
      <div className="mb-4 flex items-start justify-between gap-4 border-b border-[#e5ecf7] px-5 py-4">
        <div>
          {eyebrow ? (
            <p className="text-xs font-semibold tracking-[0.06em] text-[#7a8699]">{eyebrow}</p>
          ) : null}
